...
use auraswap::querier::{query_balance, query_pair_info_from_pair};
...
use auraswap::asset::{AssetInfo, PairInfo, PairInfoRaw};
...
const CONTRACT_NAME: &str = "crates.io:auraswap-factory";
