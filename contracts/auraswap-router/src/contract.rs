...
use auraswap::pair::SimulationResponse;
use auraswap::querier::{query_pair_info, reverse_simulate, simulate};
use auraswap::router::{
...
const CONTRACT_NAME: &str = "crates.io:auraswap-router";
...
pub fn query_config(deps: Deps) -> StdResult<ConfigResponse> {
    ...
    let resp = ConfigResponse {
        auraswap_factory: deps
            .api
            .addr_humanize(&state.auraswap_factory)?
            .to_string(),
    };
