...
use std::str::FromStr;
use auraswap::asset::{Asset, AssetInfo, PairInfo, PairInfoRaw};
use auraswap::pair::{
    Cw20HookMsg, ExecuteMsg, InstantiateMsg, MigrateMsg, PoolResponse, QueryMsg,
    ReverseSimulationResponse, SimulationResponse,
};
use auraswap::querier::query_token_info;
use auraswap::token::InstantiateMsg as TokenInstantiateMsg;

// version info for migration info
const CONTRACT_NAME: &str = "crates.io:auraswap-pair";
    ...
    Ok(Response::new().add_submessage(SubMsg {
        ...
        msg: WasmMsg::Instantiate {
            ...
            msg: to_binary(&TokenInstantiateMsg {
                name: "auraswap liquidity token".to_string(),
