...
async function store() {
    ...
    const auraFactory = fs.readFileSync(`${__dirname}/../../artifacts/auraswap_factory.wasm`);
    const auraFactoryResponse = await client.upload(account.address, auraFactory, uploadFee, 'Upload auraswap-factory contract code');
