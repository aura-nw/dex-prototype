...
async function store() {
    ...
    const auraRouter = fs.readFileSync(`${__dirname}/../../artifacts/auraswap_router.wasm`);
    const auraRouterResponse = await client.upload(account.address, auraRouter, uploadFee, 'Upload auraswap-router contract code');
