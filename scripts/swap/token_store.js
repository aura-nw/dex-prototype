...
async function store() {
    ...
    const auraToken = fs.readFileSync(`${__dirname}/../../artifacts/auraswap_token.wasm`);
    const auraTokenResponse = await client.upload(account.address, auraToken, uploadFee, 'Upload auraswap-token contract code');
