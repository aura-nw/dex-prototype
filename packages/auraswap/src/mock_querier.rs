...
pub struct WasmMockQuerier {
    ...
    auraswap_factory_querier: AuraswapFactoryQuerier,
}
...
impl WasmMockQuerier {
    pub fn new(base: MockQuerier) -> Self {
        WasmMockQuerier {
            ...
            auraswap_factory_querier: AuraswapFactoryQuerier::default(),
        }
    }
    ...
    // configure the auraswap pair
    pub fn with_auraswap_factory(
        &mut self,
        pairs: &[(&String, &PairInfo)],
        native_token_decimals: &[(String, u8)],
    ) {
        self.auraswap_factory_querier = AuraswapFactoryQuerier::new(pairs, native_token_decimals);
    }
